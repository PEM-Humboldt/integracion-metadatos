---
title: "Manejo de archivos de configuración y traducción en Dataverse"
...
Notar: `stringi` contiene funciones que permiten trabajar con los codigos de caracteres unicode:
...
He intentado rapidamente acceder a los archivos desde la API de google pero parece que no está habilitada...
Por ahora vamos a pasar por una descarga en formato excel...
...
Averiguar que las columnas de cada parte de los archivos de configuración corresponden con lo esperado:
...
* averiguar que los nombres de bloques correspondan en todo el archivo
   + en la descripción de las variables (que corresponda a nombre de bloque)
   + que sean unicos
